 ...
 *
 */
#define CONFIGURATION_ADV_H_VERSION 20200710
...
#define E4_AUTO_FAN_PIN ZRIB_V20_D6_PIN
#define E5_AUTO_FAN_PIN ZRIB_V20_D6_PIN
...
//
#if HAS_ADC_BUTTONS
  #define ADC_BUTTON_DEBOUNCE_DELAY 512  // (ms) Increase if buttons bounce or repeat too fast
#endif
 ...
 */
  ...
  #define PROBE_PT_1_X ZONESTAR_P802QS_MESH_MIN_X
  #define PROBE_PT_1_Y    Y_BED_SIZE - MESH_INSET
  #define PROBE_PT_2_X ZONESTAR_P802QS_MESH_MIN_X
 ...
 */
  ...
  //#define MESH_MAX_X MIN(X_BED_SIZE - MESH_INSET, X_BED_SIZE - MESH_INSET - ZONESTAR_P802QS_NOZZLE_PROBE_OFFSET_X)
  //#define MESH_MAX_Y MIN(Y_BED_SIZE - MESH_INSET, Y_BED_SIZE - MESH_INSET - ZONESTAR_P802QS_NOZZLE_PROBE_OFFSET_Y)
#endif
