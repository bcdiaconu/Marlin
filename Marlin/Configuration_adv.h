...
#define MESH_MIN_X MAX(MESH_INSET, X_MIN_POS + MESH_INSET + NOZZLE_PROBE_OFFSET_X)
#define MESH_MIN_Y MAX(MESH_INSET, Y_MIN_POS + MESH_INSET + NOZZLE_PROBE_OFFSET_Y)
